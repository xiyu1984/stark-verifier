...
use crate::plonky2_verifier::chip::{
...
impl<F: PrimeField> CustomGateConstrainer<F> for CosetInterpolationGateConstrainer {
    fn eval_unfiltered_constraint(
        &self,
        ctx: &mut RegionCtx<'_, F>,
        goldilocks_chip_config: &GoldilocksChipConfig<F>,
        _local_constants: &[crate::plonky2_verifier::types::assigned::AssignedExtensionFieldValue<F, 2>],
        local_wires: &[crate::plonky2_verifier::types::assigned::AssignedExtensionFieldValue<F, 2>],
        _public_inputs_hash: &crate::plonky2_verifier::types::assigned::AssignedHashValues<F>,
    ) -> Result<
        Vec<crate::plonky2_verifier::types::assigned::AssignedExtensionFieldValue<F, 2>>,
    ...
    > {
        ...
        let neg_shift = goldilocks_extension_chip.scalar_mul(ctx, &shift, -GoldilocksField::ONE)?;
        ...
        let values: Vec<
            crate::plonky2_verifier::chip::goldilocks_extension_algebra_chip::AssignedExtensionAlgebra<_>,
        > = (0..self.num_points())
...
fn partial_interpolate_ext_algebra_target<F: PrimeField>(
    ...
    values: &[crate::plonky2_verifier::chip::goldilocks_extension_algebra_chip::AssignedExtensionAlgebra<F>],
    barycentric_weights: &[GoldilocksField],
    point: &crate::plonky2_verifier::chip::goldilocks_extension_algebra_chip::AssignedExtensionAlgebra<F>,
    initial_eval: crate::plonky2_verifier::chip::goldilocks_extension_algebra_chip::AssignedExtensionAlgebra<
        F,
    >,
    initial_partial_prod: crate::plonky2_verifier::chip::goldilocks_extension_algebra_chip::AssignedExtensionAlgebra<
        F,
    >,
        ...
        .fold(
            ...
            |(eval, partial_prod), ((val, x), weight)| {
                let extension = goldilocks_extension_chip
                    .constant_extension(ctx, &[GoldilocksField::from(x), GoldilocksField::ZERO])
                    .unwrap();
                ...
                let weight_target = goldilocks_extension_chip
                    .constant_extension(ctx, &[GoldilocksField::from(weight), GoldilocksField::ZERO])
                    .unwrap();
